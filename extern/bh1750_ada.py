...
# MODIFIED - fs 2023-08-23 - removed adafruit lib to make it run with micropython
#
"""
`adafruit_bh1750`
================================================================================
...
class BH1750:  # pylint:disable=too-many-instance-attributes
    ...
    **Quickstart: Importing and using the BH1750**
    ...
    def __init__(self, address: int = _BH1750_DEFAULT_ADDRESS) -> None:
        #self.i2c_device = i2c_device.I2CDevice(i2c, address)
        self.i2c_device = i2cdevice.I2CDevice(address)
